...
export default function NewProductPage() {
  ...
  const [variants, setVariants] = useState([
    { size: "", color: "", price: 0, stockQuantity: 0 }
  ]);
  ...
  const addVariant = () => {
    setVariants([...variants, { size: "", color: "", price: 0, stockQuantity: 0 }]);
  };
  ...
  return (
    <div className="max-w-4xl mx-auto pb-10">
      <h1 className="font-serif text-2xl font-bold mb-6">Thêm Sản Phẩm Mới</h1>
